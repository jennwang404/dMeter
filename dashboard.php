 ...
 <body>
  <?php
      ...
      if (isset($_POST['submit']) && $_POST['submit']=="LOG OUT") {
        ...
        $newurl =  substr($url, 0, -9)."index.php";
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
	...
	<table>
		<tr>
			<td id = "sublansing" class = "selected" onclick = "loadCard('sublansing')"></td>
    ...
    <script type = "text/javascript">
		var selected = "sublansing";
		$.ajax({
        type: "GET",
        url: "sublansing.php",
        success: function (data) { 
			$('#sublansing').html(data);
        }
		});
		...
		function loadCard(region){
			...
			$('#sublansing').html("").addClass("tmp");
			$('#subnorth').html("").addClass("tmp");
			$('#subsouth').html("").addClass("tmp");
