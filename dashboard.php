 ...
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
	...
	<div id = "subnorth"><div class = "tmp"><span>Community</span></div></div>
	<div id = "subsouth"><div class = "tmp"><span>Economic</span></div></div>
    ...
    <script type = "text/javascript">
		...
		function nextCard(){
			$('#digital_download').html("");
			if (region==1){
				$.ajax({
				type: "GET",
				url: "sublansing.php",
				success: function (data) { 
					$('#digital_download').html(data);
					region = 2;
				}
