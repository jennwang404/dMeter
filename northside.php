  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class = "card">
    		<div class = "contain">
    			<div class = "buttons">
    				<span class = "btn" id = "button0" onclick = "changeGraph('yeardata.php', 0)">year</span>
    				<span class = "btn" id = "button1" onclick = "changeGraph('monthdata.php', 1)">month</span>
    				<span class = "btn" id = "button2" onclick = "changeGraph('yeardata.php', 2)">week</span>
    			...
    			<script>
    				...
    				*/
    				changeGraph("monthdata.php",1);
    			</script>
    			<div id = "notifs">
            <div id= "delochart"></div>
    			</div>
    		</div>
    	</div><div class = "card" id = "north">
      <div class = "contain">
        <div class = "buttons">
